      ...
      <Modal visible={showAlertModal} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { height: 250 }]}> 
            ...
            <Text style={styles.modalDesc}>현재는 신용카드 결제만 가능합니다.</Text>
...
const styles = StyleSheet.create({
  ...
  iconBox: { 
    width: 60, height: 60, borderRadius: 30, backgroundColor: '#FAE100', 
  ...
  modalContent: { 
    width: '85%', height: 400, backgroundColor: 'white', 
    alignItems: 'center', justifyContent: 'center', borderRadius: 16, padding: 20
  },
  modalTitle: { fontSize: 22, fontWeight: 'bold', color: '#333', marginBottom: 10, textAlign: 'center' },
  modalDesc: { fontSize: 16, marginBottom: 20, textAlign: 'center', color: '#555' },
  cardSlotPlaceholder: { 
