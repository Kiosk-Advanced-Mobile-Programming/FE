...
const MEGA_START_IMAGE = require('../../../assets/megaimages/megaStart.png');

export default function StartPage() {
    const params = useLocalSearchParams(); // level에서 보낸 모든 파라미터를 받음

    // 클릭 시 megacoffee.tsx 화면으로 이동하는 함수
    const navigateToMainScreen = () => {
        // 'replace'를 사용하여 StartPage를 히스토리에서 제거하고 메인 화면으로 전환합니다.
        // 메가커피 메인 화면 경로: '/(flow)/megacoffee'
        router.replace({ pathname: '/megacoffee/megacoffee', params: params }); 
    };
