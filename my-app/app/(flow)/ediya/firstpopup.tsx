...
const CartDetailPage: React.FC = () => {
    ...
    const cartTotalPrice = cartItems.reduce((total, item) => {
        ...
        return total + (item.basePrice + itemOptionCost) * item.quantity;
    }, 0);
            ...
            <View style={styles.modalFooter}>
                ...
                <View style={styles.modalActionButtons}>
                    ...
                    <Pressable style={styles.modalActionButtonBack} onPress={() => router.back()}>
                        <Text style={styles.modalActionButtonText}>이전</Text>
                    </Pressable>
                    {/* 먹고가기 버튼 */}
                    ...
                    <Pressable 
                        ...
                        onPress={() => handlePaymentSelection('take_out')} // <-- totalPrice, orderType 전달
                    >
                        <Text style={styles.modalActionButtonText}>다음</Text>
                        <Text style={styles.modalActionButtonSubText}></Text>
                    </Pressable>
                </View>
            </View>
